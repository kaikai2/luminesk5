...
struct Set
{
    ...
    Set(int _x, int _r, int _s, int _h):x((unsigned char)_x),r((unsigned char)_r),score(_s),height((unsigned char)_h){}
    unsigned char x, r;
...
struct Sets
{
    ...
    {
        x[0] = (unsigned char)_x;
        r[0] = (unsigned char)_r;
        score = _s;
        height = (unsigned char)_h;
    }
    Sets(const Sets &o, int _x, int _r, int _s, int _h)
    {
        ...
        x[level] = (unsigned char)_x;
        r[level] = (unsigned char)_r;
        score = o.score + _s;
        height = (unsigned char)max(o.height, _h);
    }
